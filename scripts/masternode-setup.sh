...
CONFIGFOLDER='/root/.Intarocryptocurrency'
COIN_DAEMON='intarocryptocurrencyd'
COIN_CLI='intarocryptocurrencyd'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/intarocryptocurrency/intarocryptocurrency.git'
#COIN_TGZ='http://www.mastermasternode.com/intarocryptocurrency/XXX.zip'
...
purgeOldInstallation() {
    ...
    # TODO - Make Backup of Wallet.dat, Intarocryptocurrency.conf, and masternode.conf
	# Save Key
