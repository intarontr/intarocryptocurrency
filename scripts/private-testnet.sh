...
./intarocryptocurrencyd --datadir=./test1 &
./intarocryptocurrencyd --datadir=./test2 &
./intarocryptocurrencyd --datadir=./test3 &
./intarocryptocurrencyd --datadir=./test4 &
./intarocryptocurrencyd --datadir=./test5 &
./intarocryptocurrencyd --datadir=./test6 &
./intarocryptocurrencyd --datadir=./test7 &
