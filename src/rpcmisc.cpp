...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <Intarocryptocurrencyaddress>\n"
            "Return information about <Intarocryptocurrencyaddress>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <Intarocryptocurrencypubkey>\n"
            "Return information about <Intarocryptocurrencypubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <Intarocryptocurrencyaddress> <signature> <message>\n"
