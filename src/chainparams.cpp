...
uint256 scrypt_blockhash(const void* input);
		const char* pszTimestamp = "Here 18 Dec 2017 we start the Intarocryptocurrency";
		...
		assert(genesis.hashMerkleRoot == uint256("0x51f0efd488f3e30908b9afeb7ac5e3fd591a1893ada6c36dfe74f18a47ae7622"));
		/*if(true)
		{
		...
		assert(hashGenesisBlock == uint256("0x0000579afb6163716310276dae7bde0f1667193ca6fa01955644ac5a0333da0d"));
		...
		/*vSeeds.push_back(CDNSSeedData("america", "america.intarocryptocurrency.org"));
		vSeeds.push_back(CDNSSeedData("europ", "europ.intarocryptocurrency.org"));
		vSeeds.push_back(CDNSSeedData("asia",  "asia.intarocryptocurrency.org"));
		vSeeds.push_back(CDNSSeedData("explorer",  "explorer.intarocryptocurrency.org"));
