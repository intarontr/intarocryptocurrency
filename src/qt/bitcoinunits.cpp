...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Intarocryptocurrencys");
    case mBTC: return QString("Milli-Intarocryptocurrencys (1 / 1,000)");
    case uBTC: return QString("Micro-Intarocryptocurrencys (1 / 1,000,000)");
    default: return QString("???");
    }
}
