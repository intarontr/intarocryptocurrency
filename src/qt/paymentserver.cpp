...
const QString BITCOIN_IPC_PREFIX("Intarocryptocurrency:");
...
{
    QString name("IntarocryptocurrencyQt");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Intarocryptocurrency: click-to-pay handler");
    else
