...
{
    resize(900, 520);
    setWindowTitle(tr("Intarocryptocurrency") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("Intarocryptocurrency");
    setStyleSheet("#Intarocryptocurrency { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Intarocryptocurrency address"));
    ...
    aboutAction = new QAction(QIcon(":icons/intarocryptocurrency"), tr("&About Intarocryptocurrency"), this);
    aboutAction->setToolTip(tr("Show information about Intarocryptocurrency"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Intarocryptocurrency"));
    ...
    editConfigAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit Intarocryptocurrency.conf"), this);
    editConfigAction->setToolTip(tr("Edit the configuration file for Intarocryptocurrency"));
    editConfigExtAction = new QAction(QIcon(":/icons/editconf"), tr("&Edit Intarocryptocurrency.conf (external)"), this);
    editConfigExtAction->setToolTip(tr("Edit the configuration file for Intarocryptocurrency (external editor)"));
    openDataDirAction = new QAction(QIcon(":/icons/folder"), tr("&Open data dir"), this);
    openDataDirAction->setToolTip(tr("Open the directory where Intarocryptocurrency data is stored"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Intarocryptocurrency client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Intarocryptocurrency client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Intarocryptocurrency network", "", count));
}
...
{
    QString strTitle = tr("Intarocryptocurrency") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Intarocryptocurrency address or malformed URI parameters."));
    }
