...
static const int64_t STATIC_POS_REWARD = 1 * COIN; //Constant reward of 3.4 NTR per block has been ignored
...
static const int64_t MIN_TX_FEE = 555;
/** Fees smaller than this (in satoshi) are considered zero fee (for relaying) */
static const int64_t MIN_RELAY_TX_FEE = MIN_TX_FEE;
/** No amount larger than this (in satoshi) is valid */
static const uint64_t MAX_MONEY = 595555555555 * COIN;//  59555555555 * COIN; // 5M PoW coins
